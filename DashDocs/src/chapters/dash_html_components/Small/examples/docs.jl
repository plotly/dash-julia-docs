...
A `Small` component. `Small` is a wrapper for the `<small>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/small](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/small)
