...
An Acronym component. Acronym is a wrapper for the `<acronym>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/acronym](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/acronym/)
