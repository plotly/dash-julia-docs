...
A `Font` component. `Font` is a wrapper for the `<font>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/font](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/font)
