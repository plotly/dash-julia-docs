...
A `Colgroup` component. `Colgroup` is a wrapper for the `<colgroup>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/colgroup](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/colgroup)
#### Keyword arguments:
