@doc_chapter "/basic-callbacks" begin
    @example hello_slider "hello-slider.jl"
    @example multi_inputs "multi-inputs.jl"
    @example multi_outputs "multi-outputs.jl"
    @example simple_callback "simple-callback.jl"
    @example basic_input "basic-input.jl"
    @example basic_state "basic-state.jl"
    @example callback_chain "getting-started-callback-chain.jl"
    ...
    @layout html_div() do
        ...
        """),
        source"multi_outputs",
        layout"multi_outputs",
        dcc_markdown("""
        ...
        """),
        source"callback_chain",

        layout"callback_chain",
