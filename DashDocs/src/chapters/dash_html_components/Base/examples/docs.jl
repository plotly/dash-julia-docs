...
A Base component. Base is a wrapper for the `<base>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/base](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/base)
...
* a`ria-*` (String; optional): A wildcard aria attribute.
