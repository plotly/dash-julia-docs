module chapters_dash_bio_molecule3dviewer
...
molecule3dviewer_default = LoadExampleCode(string(examples_path, "/default.jl"))

molecule3dviewer_backgroundcolor = LoadExampleCode(string(examples_path, "/background_color.jl"))

molecule3dviewer_isosurfaces = LoadExampleCode(string(examples_path, "/isosurfaces.jl"))

molecule3dviewer_labels = LoadExampleCode(string(examples_path, "/labels.jl"))

molecule3dviewer_selectiontype = LoadExampleCode(string(examples_path, "/selection_type.jl"))

molecule3dviewer_shapes = LoadExampleCode(string(examples_path, "/shapes.jl"))


examples = [
  molecule3dviewer_default
]

app =  dash()

molecule3dviewer_default.callback!(app)
...
app.layout = html_div() do
    ...
    """),
    molecule3dviewer_default.source_code,
    molecule3dviewer_default.layout,
    ...
    """),
    molecule3dviewer_selectiontype.source_code,
    molecule3dviewer_selectiontype.layout,
    ...
    """),
    molecule3dviewer_backgroundcolor.source_code,
    molecule3dviewer_backgroundcolor.layout,
    ...
    """),
    molecule3dviewer_labels.source_code,
    molecule3dviewer_labels.layout,
    ...
    """),
    molecule3dviewer_shapes.source_code,
    molecule3dviewer_shapes.layout,
    ...
    """),
    molecule3dviewer_isosurfaces.source_code,
    molecule3dviewer_isosurfaces.layout,
