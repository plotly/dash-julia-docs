...
checkbox_vertical = LoadExampleCode(string(examples_path, "/checklist_vertical.jl"))

checkbox_horizontal = LoadExampleCode(string(examples_path, "/checklist_horizontal.jl"))
