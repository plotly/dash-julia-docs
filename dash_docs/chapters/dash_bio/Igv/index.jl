...
igv_default = LoadExampleCode(string(examples_path, "/default.jl"))

igv_genome = LoadExampleCode(string(examples_path, "/genome.jl"))

igv_locus = LoadExampleCode(string(examples_path, "/locus.jl"))

igv_minimumbases = LoadExampleCode(string(examples_path, "/minimum_bases.jl"))

igv_reference = LoadExampleCode(string(examples_path, "/reference.jl"))
...
app.layout = html_div() do
    ...
    """),
    igv_reference.source_code,
    igv_reference.layout,
    ...
    """),
    igv_minimumbases.source_code,
    igv_minimumbases.layout,
