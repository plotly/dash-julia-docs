...
A `Hgroup` component. `Hgroup` is a wrapper for the `<hgroup>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/hgroup](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/hgroup)
#### Keyword arguments:
