...
A Bdo component. Bdo is a wrapper for the `<bdo>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/bdo](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/bdo)
