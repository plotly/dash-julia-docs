...
A `Sub` component. `Sub` is a wrapper for the `<sub>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/sub](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/sub)
