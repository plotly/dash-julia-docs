...
A `Col` component. `Col` is a wrapper for the `<col>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/col](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/col)
#### Keyword arguments:
