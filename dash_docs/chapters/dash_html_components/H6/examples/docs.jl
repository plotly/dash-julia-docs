...
A H6 component. H4 is a wrapper for the `<h6>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/h6](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/h6)
