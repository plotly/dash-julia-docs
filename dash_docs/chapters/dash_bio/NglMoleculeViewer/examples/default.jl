...
app.layout = html_div([
  ...
  dashbio_nglmoleculeviewer(id="default-ngl"),
])
callback!(app,
    [Output("default-ngl", "data"),
     Output("default-ngl", "molStyles")],
     Input("default-dropdown", "value")) do value
      molstyles_dict = Dict(
    ...
    data_list = [DashBioUtils.get_data(data_path, value, "red", reset_view=true, loc=false)]
