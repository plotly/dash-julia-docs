...
A `Del` component. `Del` is a wrapper for the `<del>`HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/del](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/del)
#### Keyword arguments:
