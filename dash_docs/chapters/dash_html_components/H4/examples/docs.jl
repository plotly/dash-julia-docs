...
A H4 component. H4 is a wrapper for the `<h4>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/h4](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/h4)
