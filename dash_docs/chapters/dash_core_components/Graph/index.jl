module chapters_dash_core_components_graph
...
express_graph = LoadExampleCode(string(examples_path, "/express_graph.jl"))

figure_graph = LoadExampleCode(string(examples_path, "/figure_graph.jl"))

app =  dash()

examples = [figure_graph, express_graph]
...
app.layout = html_div() do
    ...
    express_graph.source_code,
    express_graph.layout,
