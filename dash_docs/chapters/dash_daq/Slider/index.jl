module chapters_dash_daq_slider
...
slider_default = LoadExampleCode(string(examples_path, "/default.jl"))

slider_handlelabel = LoadExampleCode(string(examples_path, "/handle_label.jl"))

slider_marks = LoadExampleCode(string(examples_path, "/marks.jl"))

slider_size = LoadExampleCode(string(examples_path, "/size.jl"))

slider_step = LoadExampleCode(string(examples_path, "/step.jl"))

slider_verticalorientation = LoadExampleCode(string(examples_path, "/vertical_orientation.jl"))
...
app.layout = html_div() do
    ...
    slider_default.source_code,
    slider_default.layout,

    html_h3("Marks"),

    dcc_markdown("""Set custom marks on the slider using with `marks`."""),

    slider_marks.source_code,
    slider_marks.layout,
    ...
    slider_handlelabel.source_code,
    slider_handlelabel.layout,
    ...
    slider_verticalorientation.source_code,
    slider_verticalorientation.layout,
