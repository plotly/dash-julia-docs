...
A `Rtc` component. `Rtc` is a wrapper for the `<rtc>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/rtc](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/rtc)
#### Keyword arguments:
