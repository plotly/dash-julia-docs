...
A `Param` component. `Param` is a wrapper for the `<param>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/param](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/param)
