...
A `Var` component. `Var` is a wrapper for the `<var>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/var](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/var)
