...
A `Content` component. `Content` is a wrapper for the `<content>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/content](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/content)
#### Keyword arguments:
