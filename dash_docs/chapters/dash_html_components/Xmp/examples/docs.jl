...
A `Xmp` component. `Xmp` is a wrapper for the `<xmp>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/xmp](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/xmp)
