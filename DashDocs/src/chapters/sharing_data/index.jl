@doc_chapter "/sharing-data-between-callbacks" begin

@example scoping_wrong  "scoping_wrong.jl"
@example scoping  "scoping.jl"
...
@layout html_div() do
    ...
    **Dash callbacks must never modify variables outside of their scope**. It is not safe to
    ...
    "),
    source"scoping_wrong",
    Example(layout"scoping_wrong"),
