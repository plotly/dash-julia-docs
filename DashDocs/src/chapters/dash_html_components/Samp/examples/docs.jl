...
A `Samp` component. `Samp` is a wrapper for the `<samp>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/samp](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/samp)
