...
A `Rt` component. `Rt` is a wrapper for the `<rt>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/rt](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/rt)
#### Keyword arguments:
