module chapters_dash_bio_ideogram
...
ideogram_default = LoadExampleCode(string(examples_path, "/default.jl"))

ideogram_annotations = LoadExampleCode(string(examples_path, "/annotations.jl"))

ideogram_brush = LoadExampleCode(string(examples_path, "/brush.jl"))

ideogram_heightwidth = LoadExampleCode(string(examples_path, "/height_width.jl"))

ideogram_orientation = LoadExampleCode(string(examples_path, "/orientation.jl"))

ideogram_rotatability = LoadExampleCode(string(examples_path, "/rotatability.jl"))
...
app.layout = html_div() do
    ...
    """),
    ideogram_default.source_code,
    ideogram_default.layout,
    ...
    """),
    ideogram_heightwidth.source_code,
    ideogram_heightwidth.layout,
    ...
    """),
    ideogram_annotations.source_code,
    ideogram_annotations.layout,
    ...
    """),
    ideogram_rotatability.source_code,
    ideogram_rotatability.layout,
    ...
    """),
    ideogram_orientation.source_code,
    ideogram_orientation.layout,
    ...
    """),
    ideogram_brush.source_code,
    ideogram_brush.layout,
