...
A `Rb` component. `Rb` is a wrapper for the `<rb>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/rb](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/rb)
#### Keyword arguments:
