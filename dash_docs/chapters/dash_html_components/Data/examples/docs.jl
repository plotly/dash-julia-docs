...
A `Data` component. `Data` is a wrapper for the `<data>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/data](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/data)
#### Keyword arguments:
