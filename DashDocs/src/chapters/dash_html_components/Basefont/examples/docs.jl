...
For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/basefont]([https:/](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/basefont)/)
