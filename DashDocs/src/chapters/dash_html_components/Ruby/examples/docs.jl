...
A `Ruby` component. `Ruby` is a wrapper for the `<ruby>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/ruby](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/ruby)
