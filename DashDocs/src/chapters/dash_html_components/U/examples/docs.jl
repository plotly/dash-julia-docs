...
An `U` component. `U` is a wrapper for the `<u>` HTML5 element. For detailed attribute info see: [https://developer.mozilla.org/en-US/docs/Web/HTML/Element/u](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/u)
